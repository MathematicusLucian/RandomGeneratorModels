import pytest
import numpy as np
from binarynumpy import RandomGenBinarySearchNumpy
...
def test_constructor():
    ...
    random_gen = RandomGenBinarySearchNumpy(__random_nums, __probs)
...
def test_positive_next_num_once__valid_random_num(probs, random_nums):
    random_gen = RandomGenBinarySearchNumpy(random_nums,probs)
