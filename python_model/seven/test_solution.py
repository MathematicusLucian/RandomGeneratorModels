import pytest
from binarysearch import RandomGenBinarySearch
...
def test_constructor():
    ...
    random_gen = RandomGenBinarySearch(__random_nums, __probs)
...
def test_positive_next_num_once__valid_random_num(probs, random_nums):
    random_gen = RandomGenBinarySearch(random_nums,probs)
